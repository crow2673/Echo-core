...
WATCH_DIRS = [Path("/home/andrew/Echo/core")]

ROOT_ALLOWLIST = {
    Path("/home/andrew/Echo/echo_core_daemon.py"),
    Path("/home/andrew/Echo/echo_command.py"),
    Path("/home/andrew/Echo/registry.json"),
}
INCLUDE = ["*.py", "*.sh", "*.md"]
...
def iter_files():
    # Also watch a few critical root files
    for extra in ROOT_ALLOWLIST:
        try:
...
def init_baseline() -> int:
    """
    Optional helper: create baseline state if missing.
